...
--
-- Host: localhost    Database: basketballdb
-- ------------------------------------------------------
...
--
-- Table structure for table `boston_celtics_per_game_stats_renamed`
--
...
--
-- Dumping data for table `boston_celtics_per_game_stats_renamed`
--

LOCK TABLES `boston_celtics_per_game_stats_renamed` WRITE;
/*!40000 ALTER TABLE `boston_celtics_per_game_stats_renamed` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `boston_celtics_per_game_stats_renamed` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-11-18  0:59:17
